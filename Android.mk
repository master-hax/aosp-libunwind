...
ifeq ($(TARGET_ARCH),$(filter $(TARGET_ARCH),arm x86 mips x86_64))
libunwind_includes += \
	$(LOCAL_PATH)/include/tdep-$(TARGET_ARCH) \
...
# 32 vs 64 bits specific
ifeq ($(TARGET_ARCH),$(filter $(TARGET_ARCH),arm x86 mips))
LOCAL_SRC_FILES += \
	src/elf32.c \
